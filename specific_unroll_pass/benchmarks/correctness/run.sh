PATH2LIB=~/specific_unroll/F22_EECS583_HW2Template/build/HW2/LLVMHW2.so        # Specify your build directory in the project
PASS=-fplicm-correctness               
...
opt -enable-new-pm=0 -indvars -loop-simplify ${1}.bc -o ${1}.ls.bc
# # Instrument profiler
